...
public class CreatureWorld extends World
{
    ...
    public void act()
    {
        ...
        {
            //TODO (180): If the player one creature at the current index of the array's current health is greater than 0...
            if(playerTwoCreatures[j].getHealthBar().getCurrent() > 0)
            {
                //TODO (181): Set playerOneLose to false
                playerTwoLose = false;
            }
        }
    ...
    public Creature getPlayerTwo()
    {
        ...
        if(playerTwoCreature.equalsIgnoreCase("Pikachu"))
        {
            //TODO (161): Initialize currentPlayerOne to the first element of the playerOneCreatures array
     ...
     */
    /**
     * changePlayerOne is a methoad that is making player one change to a different player and removing the current player out of the world.
     * 
     * @param there is a String param Called creature
     * @return Nothing is returned
     */
